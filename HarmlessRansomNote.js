function harmlessRansomNote(noText, magazineText) {
  // noText string and magazineText string into array of words
  const noteArr = noText.split(" ");
  const magazineArr = magazineText.split(" ");
  //   what words do we have in out magazine and how many
  let magazineObj = {};
